...
// non-empty values. It returns nil if the input is empty or if no non-empty parts are found.
...
// parseFlexibleBool parses common flexible boolean string representations into a boolean value.
// It accepts "1", "true", "yes", and "on" as true and "0", "false", "no", and "off" as false; any other input returns an error.
